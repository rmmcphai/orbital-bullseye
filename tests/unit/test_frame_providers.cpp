...
TEST_CASE("CartesianBullseyeFrameProvider (current) returns exact-time frame (FR-14a)", "[frame_providers]") {
...
TEST_CASE("CartesianBullseyeFrameProvider (current) fails fast if time missing (FR-14a)", "[frame_providers]") {
  constexpr const char* kSrc = "USER_CARTESIAN_FRAME";
  CartesianBullseyeFrameProvider p{kSrc, CartesianBullseyeFrameProvider::Mode::kCurrent, 0.0};
...
TEST_CASE("CartesianBullseyeFrameProvider (timeseries) returns exact-time frame (FR-14a)", "[frame_providers]") {
  constexpr const char* kSrc = "USER_CARTESIAN_FRAME";
...
TEST_CASE("CartesianBullseyeFrameProvider (timeseries) fails fast if time missing (FR-14a)", "[frame_providers]") {
  constexpr const char* kSrc = "USER_CARTESIAN_FRAME";
  CartesianBullseyeFrameProvider p{kSrc, CartesianBullseyeFrameProvider::Mode::kTimeSeries, 0.0};
...
TEST_CASE("CartesianBullseyeFrameProvider returns kInvalidInput when frame_source_id is null", "[frame_providers]") {
